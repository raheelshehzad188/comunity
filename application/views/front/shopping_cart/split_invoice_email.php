...
<!--=== Breadcrumbs ===-->
    ...
    <?php
        ...
        foreach($sale_details as $row){
          if($this->crud_model->is_sale_of_vendor($row['sale_id'], $vendor_id)){
            //echo $vendor_id;
             // $vat= $row['vat'];
                  ...
                  <td>
                      <div class="tag-box tag-box-v3">
                          ...
                          <table>
                              ...
                              <tr><td>
                                      <strong><?php echo translate('payment_method_:');?></strong>
                      ...
                      <tbody>
                          <?php
                              ...
                              foreach ($product_details as $row1) {
                                if($this->crud_model->is_added_by('product',$row1['id'],$vendor_id)){
                                  $i++; ?>
                                      <tr>
                  ...
                  <td style="text-align:right;">
                       <table width="100%">
                          ...
                          <tr>
                              ...
                              <td style="text-align:right;padding:3px"><h2><?php echo currency($total+$vat+$shipping);?></h2></td>
                          </tr>
                       </table>
