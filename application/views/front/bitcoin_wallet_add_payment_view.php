<form style="display: none" id="bitcoin_form" action="https://www.coinpayments.net/index.php" method="post">
    ...
    <input type="hidden" name="item_name" value="Wallet Add">
    <input type="hidden" name="currency" value="USD">
    <input type="hidden" name="amountf" value="<?= $final_amount?>>">
    <input type="hidden" name="want_shipping" value="0">
    <input type="hidden" name="success_url" value="<?= base_url('home/bitcoin_wallet_success')?>">
    <input type="hidden" name="cancel_url" value="<?= base_url('home/bitcoin_wallet_cancel')?>">
