...
<section class="deal_sneaker_wrap" style="padding-top: 0px">

    <div class="deal_sneaker_wrap container">
    	<div class="item">
	    	<div class="row">
	                ...
	                <div class="thumbnail my-2 no-scale no-border no-padding thumbnail-banner size-1x<?php echo $count; ?>">
	                    ...
	                    <div class="media">
	                        ...
	                        <a class="media-link" href="<?php echo $row['link']; ?>">
	                            ...
	                            <div class="img-bg image_delay" data-src="<?php echo $this->crud_model->file_view('banner',$row['banner_id'],'','','no','src','','',$row['image_ext']) ?>" style=""></div>
