...
?>
	<tr>
		<td class="description">
			...
			<?php
				$num = $this->crud_model->message_to_seller_unread_messages($row1['message_thread_id'],'user');
				if($num > 0){
			?>
		...
		<td class="add">
			<a class="btn btn-theme btn-theme-xs btn-icon-left message_to_vendor_view" data-id="<?php echo $row1['message_thread_id']?>" href="#">
