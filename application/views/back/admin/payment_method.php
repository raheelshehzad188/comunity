                    ...
                    <div class="row">
                       ...
                       <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="panel">
                                <div class="panel-heading bg-white">
                                    <h4 class="panel-title"><?php echo translate('Bitcoin Settings')?>  <small><a target="_blank" href="https://www.coinpayments.net/">Go to Coinpayments</a></small></h4>
                                </div>

                                <!--Panel body-->
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label"><?php echo translate('bitcoin_coinpayments_merchant');?></label>
                                        <div class="col-sm-8">
                                            <input type="text" name="bitcoin_coinpayments_merchant" value="<?php echo $bitcoin_coinpayments_merchant; ?>" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        if (input.files && input.files[0]) {
            ...
            $(input.files).each(function () {
                ...
                reader.onload = function (e) {
                    $(input).closest('.image-up').find('.image-preview').html("<div style='float:left;border:2px solid #303641;'><img height='100' src='" + e.target.result + "'></div>");
                }
            });
        }
    }
