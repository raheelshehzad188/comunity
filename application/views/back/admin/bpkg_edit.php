...
<div class="row">
    <div class="col-md-12">
        <?php
			echo form_open(base_url() . 'admin/bpkg/update/' . $row['id'], array(
                        ...
                        <div id="blog_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1">
                                    <?php echo translate('packge_title');?>
                                        </label>
                                <div class="col-sm-6">
                                    <input type="text" name="name" id="demo-hor-1" value="<?php echo $row['name']; ?>" placeholder="<?php echo translate('blog_title');?>" class="form-control required">
                                </div>
                            </div>
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1">
