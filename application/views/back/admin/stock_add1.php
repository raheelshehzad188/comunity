<div>
    <?php
		echo form_open(base_url() . 'admin/stock/get_var/', array(
	...
	?>
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <?php echo $this->crud_model->select_html('product','parent_product','title','add','demo-chosen-select required','','parent_id',0,''); ?>
                </div>
            </div>
