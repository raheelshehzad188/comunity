<div class="row">
    <div class="col-md-12">
		<?php
            echo form_open(base_url() . 'admin/bpkg/do_add/', array(
        ...
        ?>
            ...
            <div class="panel-footer">
                <div class="row">
                    ...
                    <div class="col-md-1">
                        <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right enterer" onclick="form_submit('bpkg_add','<?php echo translate('package_has_been_uploaded!'); ?>');proceed('to_add');" ><?php echo translate('upload');?></span>
                    </div>
