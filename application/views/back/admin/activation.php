                        ...
                        <div class="col-md-4">
                            <div class="panel">
                                <div class="panel-heading bg-white">
                                    <center>
                                        <h4 class="panel-title">
                                            <?php echo translate('product_affiliation')?>
                                        </h4>
                                    </center>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4 col-sm-offset-5">
                                            <input class='aiz_switchery1' type="checkbox"
                                                   ...
                                                   data-id='88'
                                                   data-tm='<?php echo translate('product_affiliation_enabled'); ?>'  data-fm='<?php echo translate('product_affiliation_disabled'); ?>'
                                                   <?php if($this->crud_model->get_settings_value('general_settings', 'product_affiliation_set', 'value') == 'ok'){ ?>checked<?php } ?> />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="panel">
                                <div class="panel-heading bg-white">
                                    <center>
                                        <h4 class="panel-title">
                                            <?php echo translate('Bitcoin (Coinpayments)')?>
                                        </h4>
                                    </center>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4 col-sm-offset-5">
                                            <input class='aiz_switchery1' type="checkbox" name="bitcoin_set" id="bitcoin_set"                                 data-set='bitcoin_set'  value="ok"
                                                   data-id=''
                                                   data-tm='<?php echo translate('bitcoin_payment_enabled'); ?>'
                                                   data-fm='<?php echo translate('bitcoin_payment_disabled'); ?>'
