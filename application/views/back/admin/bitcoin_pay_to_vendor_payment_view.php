<form style="display: none" id="bitcoin_form" action="https://www.coinpayments.net/index.php" method="post">
    ...
    <input type="hidden" name="success_url" value="<?= base_url('admin/bitcoin_pay_to_vendor_success')?>">
    <input type="hidden" name="cancel_url" value="<?= base_url('admin/bitcoin_pay_to_vendor_cancel')?>">
