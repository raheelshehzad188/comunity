            ...
            <div class="panel-heading">
                <div class="panel-control" style="float: left;">
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a data-toggle="tab" href="#select_product"><?php echo translate('select_product'); ?></a>
                        </li>
                        <li class="">
            ...
            <div class="panel-body">
                <div class="tab-base">
                    ...
                    <div class="tab-content">
                        <!--raheel code-->
                        <div id="select_product" class="tab-pane fade active in ">
                            <div class="form-group btm_border">
                                
                                <h4 class="text-thin text-center"><?php echo translate('select_product'); ?> </h4>                            
                            </div>
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-6"><?php echo translate('product');?></label>
                                <div class="col-sm-4">
                                    <div class="col-sm-6">
                                    <?php echo $this->crud_model->select_html('product','parent_product','title','add','demo-chosen-select required','','parent_id',0,'get_cat'); ?>
                                </div>
                                </div>
                ...
                <div class="row">
                	<div class="col-md-11">
                        <span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right" 
                            onclick="ajax_set_full('add1','<?php echo translate('add_product'); ?>','<?php echo translate('successfully_added!'); ?>','product_add',''); "><?php echo translate('reset');?>
                        </span>
                    </div>
