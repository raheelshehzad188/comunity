...
?>
    ...
    <div class="row">
        <div class="col-md-12">
			...
			<?php
            $msgs=$this->db->get_where('message',array(' message_thread_id'=>$row['message_thread_id']))->result_array();
            foreach ($msgs as $row1){
				$from1 = json_decode($row1['sender'],true);
            ?>
              <div class="col-md-12" >
                  <div class="col-md-12 btn btn-md btn-default overer" data-toggle="collapse" data-target="#demo<?php echo $row1['message_id']; ?>" style="cursor:pointer; background-color: #F5F5F5; border-color: #D8D8D8; margin-top: 5px;">
                  	<div class="col-md-1 text-left">
                        <div class="row" style="padding:5px;">
                            <?php
                                if($from1['type'] == 'seller'){
                            ?>
                                <img src="<?php echo base_url(); ?>uploads/vendor_logo_image/logo_<?php echo $this->session->userdata('vendor_id'); ?>.png" class="img-sm img-border" />
                            <?php
                  ...
                  <div id="demo<?php echo $row1['message_id']; ?>" class="collapse" style="text-align:justify; border-bottom:1px solid #D8D8D8">
                    <div class="col-md-1">
                    </div>
    ...
    <div>
        <?php
			echo form_open(base_url() . 'vendor/ticket/reply/'.$row['message_thread_id'], array(
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-md-offset-6">
                        ...
                        <span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right"
                            onclick="ajax_set_full('view','<?php echo translate('view_ticket'); ?>','<?php echo translate('successfully_viewed!'); ?>','ticket_view','<?php echo $row['message_thread_id']; ?>');">
